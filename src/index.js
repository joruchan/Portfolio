...
for (const project of sortedProjects) {
    ...
    if (project.linkLive) {
        component += `<a href="${project.linkLive}" target="_blank">View Live <i class="material-icons">language</i></a>`;
    }
    if (project.linkCode) {
        component += `<a href="${project.linkCode}" target="_blank">View Code <i class="material-icons">code</i></a>`;
    }
    component += `							  
				  </div>
